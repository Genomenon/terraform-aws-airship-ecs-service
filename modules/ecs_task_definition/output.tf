...
output "aws_ecs_task_definition_arn_without_revision" {
  value = try(aws_ecs_task_definition.app.0.arn_without_revision,
    aws_ecs_task_definition.app_with_docker_volume.0.arn_without_revision,
  "")
}
